...
from agents.llm.huggingface import get_huggingface_client, _build_huggingface_model
...
def build_llm() -> BaseChatModel:
    ...
    if llm_type == "huggingface":
        return _build_huggingface_model()
...
def get_llm_client():
    ...
    raise ValueError(f"Unknown LLM type: {llm_type}. "
                     f"Only 'azure_openai', 'deepseek' and 'huggingface' are currently supported.")
